...
const SHOTS = path.join(ROOT, "screenshots", "v85-landing");
...
(async () => {
  ...
  for (const w of [1280, 1440, 1920]) {
    ...
    await pg.goto(`http://127.0.0.1:${PORT}/web/index.html?_=${Date.now()}`, { waitUntil: "load", timeout: 30000 });
    await new Promise(r => setTimeout(r, 1800));
    const out = path.join(SHOTS, `index-${w}.png`);
