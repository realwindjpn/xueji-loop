...
srv.listen(PORT, "127.0.0.1", async () => {
  ...
  // 家长端
  await page2.goto(`http://127.0.0.1:${PORT}/xueji_parent_h5.html`, { waitUntil: "load" });
  ...
  // 学生端
  await page2.goto(`http://127.0.0.1:${PORT}/xueji_student_h5.html`, { waitUntil: "load" });
  await page2.evaluate(() => {
  ...
  await mpage.goto(`http://127.0.0.1:${PORT}/xueji_student_h5.html`, { waitUntil: "load" });
  ...
  // 后台
  await page2.goto(`http://127.0.0.1:${PORT}/xueji_loop_tool_api.html`, { waitUntil: "load" });
